...
//        ui->lcdNumber_4->display(5.0* value*100.0/1024.0);
        //ui->lcdNumber_4->display((6762.0/(value-9.0))-4.0);
...
void MainWindow::goStraight()
{
    ...
    _firmata->sendDigital(LEFTDIR, ARD_LOW);
    _firmata->sendPWM(RIGHTPWM, 150);
    _firmata->sendPWM(LEFTPWM, 150);
}
...
void MainWindow::Reverse()
{
    ...
    _firmata->sendDigital(LEFTDIR, ARD_HIGH);
    _firmata->sendPWM(RIGHTPWM, 100);
    _firmata->sendPWM(LEFTPWM, 100);
}
...
void MainWindow::goSharpLeft()
{
    qDebug()<<"goSharpLeft ";
    _firmata->sendDigital(LEFTDIR, ARD_HIGH); // Control direction
    _firmata->sendPWM(LEFTPWM, 150); // SPeed of motor
...
void MainWindow::on_pushButton_5_clicked() // STraight
{
    goStraight();
}


void MainWindow::on_pushButton_8_clicked() // LEft
{
    goSharpLeft();
}
...
void MainWindow::on_pushButton_7_clicked() // Reverse
{
    Reverse();
}


void MainWindow::on_pushButton_10_clicked() // Smooth Right
{
    goSmoothRight();
}


void MainWindow::on_pushButton_9_clicked() // Smooth Left
{
    goSmoothLeft();
}

// Reverse + Stop to be made
